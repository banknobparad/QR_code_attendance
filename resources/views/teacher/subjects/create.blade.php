    ...
    <div class="container d-flex flex-column">
        <div class="card shadow-sm rounded-3 my-auto col-md-12 mx-auto">
            ...
            <div class="card-body p-4">
                <form action="{{ route('subject.store') }}" method="POST" class="row">
                    @csrf
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="j-wrapper">
                                        <form method="post" class="j-pro" id="j-pro" enctype="multipart/form-data"
                                            action="{{ route('subject.students.import') }}" enctype="multipart/form-data"
                                            novalidate="">
                                            {{ csrf_field() }}
                                            <div class="j-content">
                                                <!-- start file -->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" id="Sex"name="Sex"
                                                                    class="form-control" placeholder="Enter Sex">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                ...
                                                <form action="#" method = "post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">No</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" id="e_No"name="No"
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Sex</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" id="e_Sex"name="Sex"
                                                                    class="form-control" value="" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Age</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" id="e_Age"name="Age"
                                                                    class="form-control" value="" />
                                                            </div>
                                                        </div>
                                                    </div>
